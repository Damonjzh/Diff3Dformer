...
You can used our pretrained model for CCCCII data. The preprecessed CCCCII data and pretrained model can be found at https://drive.google.com/drive/folders/1eNIEUEAoZH9GIX0ewoBkTOJ2trBGyBmO?usp=sharing. 